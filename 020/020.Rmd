...
```{r ex1, eval=FALSE, echo=FALSE, exercise=TRUE, exercise.lines = 5}
ebola %>%
...
```{r ex2, eval=FALSE, echo=FALSE, exercise=TRUE, exercise.lines = 5}
ebola %>%
  ____(____) %>%
...
```{r ex3, eval=FALSE, echo=FALSE, exercise=TRUE, exercise.lines = 5}
ebola %>%
  ____(____) %>%
  separate(name, into = c("case_death", "country"), sep = "_") %>%
